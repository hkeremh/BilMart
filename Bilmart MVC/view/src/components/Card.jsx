...
function ItemCard(props) {
  ...
  <Card style={{ width: '280px', height: "500px" }}>
    ...
    <Card.Body>
      <div>
      <Row>
      {!props.record.availability.includes("Sold") && <Col><Link to={`/item/${props.record._id}`}><Button variant="secondary" style={{backgroundColor: "#192655"}}><div className="text">View</div></Button></Link></Col>}
